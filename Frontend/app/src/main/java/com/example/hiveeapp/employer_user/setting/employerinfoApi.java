...
// this is good, I just need to add companyId things


//public class employerinfoApi {
//
//    private static final String BASE_URL = "http://coms-3090-063.class.las.iastate.edu:8080/employer/368";
//    private static final String TAG = "EmployerApi";
//    /**
//     * Generates the headers for API requests with authorization.
//     *
...
//    public static void getEmployer(Context context, int userId, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
////        String url = BASE_URL + "/" + userId;
//        String url = "http://coms-3090-063.class.las.iastate.edu:8080/employer/368";
//        Log.d(TAG, "GET employer Request URL: " + url);
//
//        JsonObjectRequest request = new JsonObjectRequest(
//                Request.Method.GET,
...
//     * @param errorListener Error listener for handling errors.
//     */
//    public static void updateEmployer(Context context, JSONObject studentData, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
//        String url = BASE_URL;
//        Log.d(TAG, "PUT Student Request URL: " + url);
//        Log.d(TAG, "Student Data Payload: " + studentData.toString());
//

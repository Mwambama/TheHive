...
public class StudentProfileActivity extends AppCompatActivity {
    ...
    private MaterialButton saveButton, manageResumeButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Navigate to Resume Management page
        manageResumeButton.setOnClickListener(v -> {
            Intent intent = new Intent(StudentProfileActivity.this, ResumeManagementActivity.class);

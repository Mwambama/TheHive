...
public class studentDetailsFragment extends DialogFragment {
    ...
    private void displayStudentDetails() {
        ...
        String studentName = studentDetails.optString("name", "N/A");
        String studentEmail = studentDetails.optString("email", "N/A");
        String studentPhone = studentDetails.optString("phone", "N/A");
        String studentUniversity = studentDetails.optString("university", "N/A");
        String studentGpa = studentDetails.optString("gpa", "N/A");
        String studentResumePath = studentDetails.optString("resumePath", "N/A");

        // Handle the graduation date
        String graduationDate = studentDetails.optString("graduationDate", "N/A");

        // Try to format the date if it's not "N/A"
        if (!"N/A".equals(graduationDate)) {
            try {
                SimpleDateFormat inputFormat = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()); // Assuming date format is yyyy-MM-dd
                SimpleDateFormat outputFormat = new SimpleDateFormat("dd/MM/yyyy", Locale.getDefault()); // Desired format dd/MM/yyyy
                Date date = inputFormat.parse(graduationDate);
                graduationDate = outputFormat.format(date); // Format the date
            } catch (ParseException e) {
                e.printStackTrace();
                graduationDate = "N/A"; // In case of error, fall back to "N/A"
            }
        }

        // Set the text views with the student details
        studentNameTextView.setText(studentName);
        studentEmailTextView.setText(studentEmail);
        studentPhoneTextView.setText(studentPhone);
        studentUniversityTextView.setText(studentUniversity);
        studentGraduationDateTextView.setText(graduationDate);
        studentGpaTextView.setText(studentGpa != null ? studentGpa : "N/A"); // Handling null GPA
        studentResumePathTextView.setText(studentResumePath);
    }

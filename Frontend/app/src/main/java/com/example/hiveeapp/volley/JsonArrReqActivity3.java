...
public class JsonArrReqActivity3 extends AppCompatActivity {
    TextView textView;
    private Button updateInfoBtn, deleteInfoBtn, fetchInfoBtn;
    private EditText nameEditText, emailEditText, phoneEditText, fieldEditText;
    private EditText streetEditText, complementEditText, cityEditText, stateEditText, zipCodeEditText;

    private String studentId = "200"; // Initialize with the actual student ID
    ...
    private void updateInfo() {
        ...
        try {
            ...
            jsonObject.put("studentId", studentId); // Use studentId
    ...
    private void deleteInfo() {
        // Assuming the URL is set properly and studentId is available
        String url = "http://coms-3090-063.class.las.iastate.edu:8080/student/" + studentId;

...
public class OnboardingActivityTest3 {
    ...
    @Test
    public void onboardingActivityTest3() {
        ViewInteraction materialButton = onView(
                allOf(withId(R.id.getStartedButton), withText("Get Started"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.viewpager2.widget.ViewPager2$RecyclerViewImpl")),
                                        0),
                                3),
                        isDisplayed()));
        ...
        ViewInteraction tabView = onView(
                allOf(withContentDescription("Application Status"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction tabView2 = onView(
                allOf(withContentDescription("Swipe"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.tabLayout),
                                        0),
